...
//     header: SiteHeader,
//   };
  params["expandAllContentLinks"] = true
...
export async function getStaticPaths({ locales, defaultLocale }) {
  ...
  //agilityPaths.append("/hi")//for fun dev purposes (TODO remove)
  return {
    paths: agilityPaths,
    fallback: true,
  };
...
const AgilityPage = (props) => {
  // const AgilityPageTemp=getPageTemplate("Test")//const AgilityPageTemp=getPageTemplate(props.pageTemplateName)
  //   return(<AgilityPageTemp {...props} />)
  return <Layout {...props} />
};
